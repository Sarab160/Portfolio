...
export const skillsData: Skill[] = [
    ...
    },
    {
        ...
        projects: [
            ...
            { title: "MNIST Handwritten Digit Classification", description: "Developed a machine learning model to classify handwritten digits from the MNIST dataset using Python and scikit-learn, with evaluation using accuracy and a confusion matrix.", github: "https://github.com/Sarab160/Minst-digit-classoifier" },
            { title: "Customer Total Charges Prediction App", description: "Built a machine learning web app using Python, Decision Tree Regressor, and Streamlit to predict customer total charges based on tenure, monthly charges, and service features, with real-time predictions and model evaluation metrics.", github: "https://github.com/Sarab160/customer_total_charges" },
            { title: "Customer Churn Prediction App", description: "Developed a machine learning web app using Python, Random Forest, and Streamlit to predict whether a customer will churn based on service and demographic features, with real-time predictions and performance metrics visualization.", github: "https://github.com/Sarab160/customer_churn-" },
