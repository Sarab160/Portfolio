...
const Hero = () => {
    return (
        <section className="flex flex-col items-center justify-center min-h-[80vh] px-4 sm:px-6 lg:px-8 py-12 md:py-20 md:flex-row md:justify-between md:gap-12 max-w-6xl mx-auto">
            <motion.div
            ...
            >
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4 justify-center md:justify-start pt-4">
                    <a
                        href="/cv.pdf"
                        target="_blank"
                        className="px-6 sm:px-8 py-2.5 sm:py-3 rounded-full bg-brand-primary text-white text-sm sm:text-base font-medium hover:bg-brand-primary-light transition-all shadow-[0_0_15px_rgba(45,0,0,0.5)] hover:shadow-[0_0_25px_rgba(91,33,182,0.6)]"
                    >
                        View CV
                    </a>
                    <a
                        href="/cv.pdf"
                        download
                        className="px-6 sm:px-8 py-2.5 sm:py-3 rounded-full border border-gray-700 text-gray-300 text-sm sm:text-base font-medium hover:border-brand-primary-light hover:text-white transition-all"
                    >
                        Download CV
                    </a>
                </div>
